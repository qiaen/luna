<template>
	<section class="report">
		...
		<el-table v-loading="xoading" class="zm-table" @selection-change="mainSelectionChange" height="100%" :data="mainTable" border>
			...
			<el-table-column prop="jobType" label="作业类型" width="108" sortable></el-table-column>
			...
			<el-table-column prop="owner" label="创建人" width="100" sortable show-overflow-tooltip></el-table-column>
